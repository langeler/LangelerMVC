            ...
            'framework-tools' => [
                ...
                'products' => [
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 50,
                        'media' => json_encode(['/assets/images/starter-platform-license.png']),
                    ],
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 20,
                        'media' => json_encode(['/assets/images/admin-operations-pack.png']),
                    ],
                ],
            ],
            'developer-extras' => [
                ...
                'products' => [
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 35,
                        'media' => json_encode(['/assets/images/queue-visibility-dashboard.png']),
                    ],
                ],
            ],
        ];
