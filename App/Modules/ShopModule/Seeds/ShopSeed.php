            ...
            'framework-tools' => [
                ...
                'products' => [
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 50,
                        'media' => json_encode(['/assets/images/starter-platform-license.svg']),
                    ],
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 20,
                        'media' => json_encode(['/assets/images/admin-operations-pack.svg']),
                    ],
                ],
            ],
            'developer-extras' => [
                ...
                'products' => [
                    [
                        ...
                        'currency' => 'SEK',
                        'stock' => 35,
                        'media' => json_encode(['/assets/images/queue-visibility-dashboard.svg']),
                    ],
                ],
            ],
        ];
