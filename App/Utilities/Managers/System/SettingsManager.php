...
class SettingsManager
{
    ...
    private const ENVIRONMENT_ALIASES = [
        ...
        'COMMERCE_DOCUMENTS_VAT_RATE_BPS' => ['file' => 'commerce', 'path' => ['DOCUMENTS', 'VAT_RATE_BPS'], 'type' => 'int'],
        'COMMERCE_DOCUMENTS_SELLER_NAME' => ['file' => 'commerce', 'path' => ['DOCUMENTS', 'SELLER_NAME']],
        'COMMERCE_DOCUMENTS_SELLER_VAT_ID' => ['file' => 'commerce', 'path' => ['DOCUMENTS', 'SELLER_VAT_ID']],
        'COMMERCE_DOCUMENTS_SELLER_ADDRESS' => ['file' => 'commerce', 'path' => ['DOCUMENTS', 'SELLER_ADDRESS']],
        'COMMERCE_RETURNS_WINDOW_DAYS' => ['file' => 'commerce', 'path' => ['RETURNS', 'WINDOW_DAYS'], 'type' => 'int'],
        'COMMERCE_RETURNS_ALLOW_EXCHANGES' => ['file' => 'commerce', 'path' => ['RETURNS', 'ALLOW_EXCHANGES']],
        'COMMERCE_RETURNS_AUTO_RESTOCK' => ['file' => 'commerce', 'path' => ['RETURNS', 'AUTO_RESTOCK']],
        ...
        'COMMERCE_SHIPPING_INTEGRATION_MODE' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'MODE']],
        'COMMERCE_SHIPPING_ACTIVE_CARRIER' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'ACTIVE_CARRIER']],
        'COMMERCE_SHIPPING_AUTO_BOOK_LABELS' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'AUTO_BOOK_LABELS']],
        'COMMERCE_SHIPPING_LABEL_FORMAT' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'LABEL_FORMAT']],
        'COMMERCE_SHIPPING_LABEL_BASE_URL' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'LABEL_BASE_URL']],
        'COMMERCE_SHIPPING_API_BASE' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'API_BASE']],
        'COMMERCE_SHIPPING_API_KEY' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'API_KEY']],
        'COMMERCE_SHIPPING_USERNAME' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'USERNAME']],
        'COMMERCE_SHIPPING_PASSWORD' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'PASSWORD']],
        'COMMERCE_SHIPPING_AUTH_SCHEME' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'AUTH_SCHEME']],
        'COMMERCE_SHIPPING_SERVICE_POINTS_URL' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'SERVICE_POINTS_URL']],
        'COMMERCE_SHIPPING_BOOKING_URL' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'BOOKING_URL']],
        'COMMERCE_SHIPPING_TRACKING_URL' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'TRACKING_URL']],
        'COMMERCE_SHIPPING_CANCELLATION_URL' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'CANCELLATION_URL']],
        'COMMERCE_SHIPPING_TIMEOUT' => ['file' => 'commerce', 'path' => ['SHIPPING', 'INTEGRATION', 'TIMEOUT'], 'type' => 'int'],
        'COMMERCE_DISCOUNT_RATE_BPS' => ['file' => 'commerce', 'path' => ['DISCOUNT', 'RATE_BPS'], 'type' => 'int'],
        'COMMERCE_DISCOUNT_MAX_MINOR' => ['file' => 'commerce', 'path' => ['DISCOUNT', 'MAX_MINOR'], 'type' => 'int'],
        'COMMERCE_INVENTORY_RESERVE_ON_CHECKOUT' => ['file' => 'commerce', 'path' => ['INVENTORY', 'RESERVE_ON_CHECKOUT']],
        'COMMERCE_INVENTORY_RELEASE_ON_CANCEL' => ['file' => 'commerce', 'path' => ['INVENTORY', 'RELEASE_ON_CANCEL']],
        'COMMERCE_INVENTORY_RESERVATION_TTL_MINUTES' => ['file' => 'commerce', 'path' => ['INVENTORY', 'RESERVATION_TTL_MINUTES'], 'type' => 'int'],
        'COMMERCE_FULFILLMENT_DEFAULT_TYPE' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'DEFAULT_TYPE']],
        'COMMERCE_FULFILLMENT_AUTO_READY_ON_CAPTURE' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'AUTO_READY_ON_CAPTURE']],
        'COMMERCE_ACCESS_DEFAULT_DOWNLOAD_LIMIT' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'ACCESS', 'DEFAULT_DOWNLOAD_LIMIT'], 'type' => 'int'],
        'COMMERCE_ACCESS_DEFAULT_ACCESS_DAYS' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'ACCESS', 'DEFAULT_ACCESS_DAYS'], 'type' => 'int'],
        'COMMERCE_ACCESS_KEY_PREFIX' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'ACCESS', 'ACCESS_KEY_PREFIX']],
        'COMMERCE_SUBSCRIPTION_DEFAULT_INTERVAL' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'SUBSCRIPTIONS', 'DEFAULT_INTERVAL']],
        'COMMERCE_SUBSCRIPTION_TRIAL_DAYS' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'SUBSCRIPTIONS', 'TRIAL_DAYS'], 'type' => 'int'],
        'COMMERCE_SUBSCRIPTION_MAX_RETRIES' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'SUBSCRIPTIONS', 'MAX_RETRIES'], 'type' => 'int'],
        'COMMERCE_SUBSCRIPTION_DUNNING_RETRY_DAYS' => ['file' => 'commerce', 'path' => ['FULFILLMENT', 'SUBSCRIPTIONS', 'DUNNING_RETRY_DAYS'], 'type' => 'list'],
        ...
        'THEME_DEFAULT' => ['file' => 'theme', 'path' => ['DEFAULT']],
        'THEME_MODE' => ['file' => 'theme', 'path' => ['MODE']],
        'THEME_ALLOW_USER_SELECTION' => ['file' => 'theme', 'path' => ['ALLOW_USER_SELECTION']],
        'THEME_ASSET_CSS' => ['file' => 'theme', 'path' => ['ASSETS', 'CSS']],
        'THEME_ASSET_JS' => ['file' => 'theme', 'path' => ['ASSETS', 'JS']],
        ...
        'PAYMENT_DRIVER' => ['file' => 'payment', 'path' => ['DRIVER']],
        'PAYMENT_CURRENCY' => ['file' => 'payment', 'path' => ['CURRENCY']],
        'PAYMENT_DEFAULT_METHOD' => ['file' => 'payment', 'path' => ['DEFAULT_METHOD']],
        'PAYMENT_DEFAULT_FLOW' => ['file' => 'payment', 'path' => ['DEFAULT_FLOW']],
        'PAYMENT_WEBHOOKS_ENABLED' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'ENABLED']],
        'PAYMENT_WEBHOOKS_REQUIRE_SIGNATURE' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'REQUIRE_SIGNATURE']],
        'PAYMENT_WEBHOOKS_SIGNATURE_HEADER' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SIGNATURE_HEADER']],
        'PAYMENT_WEBHOOKS_EVENT_ID_HEADER' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'EVENT_ID_HEADER']],
        'PAYMENT_WEBHOOKS_TIMESTAMP_HEADER' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'TIMESTAMP_HEADER']],
        'PAYMENT_WEBHOOKS_TOLERANCE_SECONDS' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'TOLERANCE_SECONDS'], 'type' => 'int'],
        'PAYMENT_WEBHOOK_SECRET_TESTING' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'testing']],
        'PAYMENT_WEBHOOK_SECRET_CARD' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'card']],
        'PAYMENT_WEBHOOK_SECRET_CRYPTO' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'crypto']],
        'PAYMENT_WEBHOOK_SECRET_PAYPAL' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'paypal']],
        'PAYMENT_WEBHOOK_SECRET_KLARNA' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'klarna']],
        'PAYMENT_WEBHOOK_SECRET_SWISH' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'swish']],
        'PAYMENT_WEBHOOK_SECRET_QLIRO' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'qliro']],
        'PAYMENT_WEBHOOK_SECRET_WALLEY' => ['file' => 'payment', 'path' => ['WEBHOOKS', 'SECRETS', 'walley']],
        'PAYMENT_CARD_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'MODE']],
        'PAYMENT_CARD_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'API_BASE']],
        'PAYMENT_CARD_API_KEY' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'API_KEY']],
        'PAYMENT_CARD_AUTH_SCHEME' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'AUTH_SCHEME']],
        'PAYMENT_CARD_CREATE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'CREATE_URL']],
        'PAYMENT_CARD_CAPTURE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'CAPTURE_URL']],
        'PAYMENT_CARD_REFUND_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'REFUND_URL']],
        'PAYMENT_CARD_CANCEL_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'CANCEL_URL']],
        'PAYMENT_CARD_RECONCILE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'card', 'RECONCILE_URL']],
        'PAYMENT_PAYPAL_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'MODE']],
        'PAYMENT_PAYPAL_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'API_BASE']],
        'PAYMENT_PAYPAL_CLIENT_ID' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'CLIENT_ID']],
        'PAYMENT_PAYPAL_CLIENT_SECRET' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'CLIENT_SECRET']],
        'PAYMENT_PAYPAL_RETURN_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'RETURN_URL']],
        'PAYMENT_PAYPAL_CANCEL_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'paypal', 'CANCEL_URL']],
        'PAYMENT_KLARNA_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'MODE']],
        'PAYMENT_KLARNA_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'API_BASE']],
        'PAYMENT_KLARNA_USERNAME' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'USERNAME']],
        'PAYMENT_KLARNA_PASSWORD' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'PASSWORD']],
        'PAYMENT_KLARNA_PURCHASE_COUNTRY' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'PURCHASE_COUNTRY']],
        'PAYMENT_KLARNA_PURCHASE_CURRENCY' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'PURCHASE_CURRENCY']],
        'PAYMENT_KLARNA_LOCALE' => ['file' => 'payment', 'path' => ['DRIVERS', 'klarna', 'LOCALE']],
        'PAYMENT_SWISH_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'MODE']],
        'PAYMENT_SWISH_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'API_BASE']],
        'PAYMENT_SWISH_PAYEE_ALIAS' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'PAYEE_ALIAS']],
        'PAYMENT_SWISH_CERTIFICATE_PATH' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'CERTIFICATE_PATH']],
        'PAYMENT_SWISH_PRIVATE_KEY_PATH' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'PRIVATE_KEY_PATH']],
        'PAYMENT_SWISH_PASSPHRASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'PASSPHRASE']],
        'PAYMENT_SWISH_CALLBACK_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'swish', 'CALLBACK_URL']],
        'PAYMENT_QLIRO_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MODE']],
        'PAYMENT_QLIRO_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'API_BASE']],
        'PAYMENT_QLIRO_API_KEY' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'API_KEY']],
        'PAYMENT_QLIRO_MERCHANT_API_KEY' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_API_KEY']],
        'PAYMENT_QLIRO_MERCHANT_API_SECRET' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_API_SECRET']],
        'PAYMENT_QLIRO_MERCHANT_CONFIRMATION_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_CONFIRMATION_URL']],
        'PAYMENT_QLIRO_MERCHANT_TERMS_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_TERMS_URL']],
        'PAYMENT_QLIRO_MERCHANT_CHECKOUT_STATUS_PUSH_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_CHECKOUT_STATUS_PUSH_URL']],
        'PAYMENT_QLIRO_MERCHANT_ORDER_MANAGEMENT_STATUS_PUSH_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'MERCHANT_ORDER_MANAGEMENT_STATUS_PUSH_URL']],
        'PAYMENT_QLIRO_CAPTURE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'CAPTURE_URL']],
        'PAYMENT_QLIRO_REFUND_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'REFUND_URL']],
        'PAYMENT_QLIRO_CANCEL_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'qliro', 'CANCEL_URL']],
        'PAYMENT_WALLEY_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'MODE']],
        'PAYMENT_WALLEY_API_BASE' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'API_BASE']],
        'PAYMENT_WALLEY_API_KEY' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'API_KEY']],
        'PAYMENT_WALLEY_WSDL_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'WSDL_URL']],
        'PAYMENT_WALLEY_USERNAME' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'USERNAME']],
        'PAYMENT_WALLEY_PASSWORD' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'PASSWORD']],
        'PAYMENT_WALLEY_MERCHANT_ID' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'MERCHANT_ID']],
        'PAYMENT_WALLEY_RETURN_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'RETURN_URL']],
        'PAYMENT_WALLEY_CALLBACK_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'CALLBACK_URL']],
        'PAYMENT_WALLEY_CREATE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'CREATE_URL']],
        'PAYMENT_WALLEY_CAPTURE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'CAPTURE_URL']],
        'PAYMENT_WALLEY_REFUND_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'REFUND_URL']],
        'PAYMENT_WALLEY_CANCEL_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'CANCEL_URL']],
        'PAYMENT_WALLEY_RECONCILE_URL' => ['file' => 'payment', 'path' => ['DRIVERS', 'walley', 'RECONCILE_URL']],
        'PAYMENT_CRYPTO_MODE' => ['file' => 'payment', 'path' => ['DRIVERS', 'crypto', 'MODE']],
        'PAYMENT_CRYPTO_DEFAULT_ASSET' => ['file' => 'payment', 'path' => ['DRIVERS', 'crypto', 'DEFAULT_ASSET']],
        'PAYMENT_CRYPTO_DEFAULT_NETWORK' => ['file' => 'payment', 'path' => ['DRIVERS', 'crypto', 'DEFAULT_NETWORK']],
        'PAYMENT_CRYPTO_CONFIRMATIONS_REQUIRED' => ['file' => 'payment', 'path' => ['DRIVERS', 'crypto', 'CONFIRMATIONS_REQUIRED'], 'type' => 'int'],
        'QUEUE_DRIVER' => ['file' => 'queue', 'path' => ['DRIVER']],
    ...
    private function resolveEnvironmentTarget(string $key): ?array
    {
        ...
        if (isset(self::ENVIRONMENT_ALIASES[$normalizedKey])) {
            ...
            $path = $this->map(
                fn(string $segment): string => (string) $segment,
                (array) ($alias['path'] ?? [])
            );
