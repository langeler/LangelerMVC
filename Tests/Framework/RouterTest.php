...
class RouterTest extends TestCase
{
    ...
    public function testRouterRegistersUserAndAdminPlatformRoutes(): void
    {
        ...
        self::assertContains('admin.catalog.categories.publish', $names);
        self::assertContains('admin.catalog.categories.unpublish', $names);
        self::assertContains('admin.catalog.categories.delete', $names);
        self::assertContains('admin.catalog.products.store', $names);
        self::assertContains('admin.catalog.products.publish', $names);
        ...
        self::assertContains('admin.pages.store', $names);
        self::assertContains('admin.pages.update', $names);
        self::assertContains('admin.pages.publish', $names);
        self::assertContains('admin.pages.unpublish', $names);
        self::assertContains('admin.pages.delete', $names);
        ...
        self::assertContains('api.admin.catalog.categories.delete', $names);
        self::assertContains('api.admin.catalog.products.store', $names);
        self::assertContains('api.admin.catalog.products.publish', $names);
        ...
        self::assertContains('api.admin.pages', $names);
        self::assertContains('api.admin.pages.store', $names);
        self::assertContains('api.admin.pages.update', $names);
        self::assertContains('api.admin.pages.publish', $names);
        self::assertContains('api.admin.pages.unpublish', $names);
        self::assertContains('api.admin.pages.delete', $names);
        ...
        self::assertContains('api.cart.discount.apply', $names);
        self::assertContains('api.cart.discount.remove', $names);
