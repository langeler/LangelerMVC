...
- Confirm migrations have run, including promotion, fulfillment, entitlement, order-state, and audit/queue tables.
- Confirm admin routes are protected by authentication and RBAC.
- Confirm payment provider credentials, webhook URLs, return URLs, and callback signatures are configured before live mode.
