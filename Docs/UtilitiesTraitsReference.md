...
- Total methods declared in traits: `816`
- Wrapper traits: `8`
- Traits with `__construct()`: `7`
- Traits with no current `App/` consumer: `13`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Data/Finder.php`, `App/Abstracts/Http/Request.php`, `App/Core/Session.php`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Data/Finder.php`, `App/Abstracts/Data/Sanitizer.php`, `App/Abstracts/Data/Validator.php`, `App/Abstracts/Database/Query.php`, `App/Abstracts/Http/Request.php`, `App/Abstracts/Http/Response.php`, `App/Abstracts/Presentation/Presenter.php`, `App/Core/Container.php`, `App/Core/Database.php`, `App/Utilities/Managers/Data/CacheManager.php`, `App/Utilities/Managers/Data/ModuleManager.php`, `App/Utilities/Managers/System/ErrorManager.php`, `App/Utilities/Managers/System/SettingsManager.php`
- Methods: `80` total (`80` public, `0` protected, `0` private)
  ...
  - `public function current(array $array): mixed` at `App/Utilities/Traits/ArrayTrait.php:245`
  - `public function end(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:256`
  - `public function key(array $array): int|string|null` at `App/Utilities/Traits/ArrayTrait.php:267`
  - `public function next(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:278`
  - `public function pos(array $array): mixed` at `App/Utilities/Traits/ArrayTrait.php:289`
  - `public function prev(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:300`
  - `public function reset(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:311`
  - `public function find(array $array, callable $callback): mixed` at `App/Utilities/Traits/ArrayTrait.php:323`
  - `public function findKey(array $array, callable $callback): int|string|null` at `App/Utilities/Traits/ArrayTrait.php:335`
  - `public function keyFirst(array $array): mixed` at `App/Utilities/Traits/ArrayTrait.php:346`
  - `public function keyLast(array $array): mixed` at `App/Utilities/Traits/ArrayTrait.php:357`
  - `public function extract(array &$array, int $flags = EXTR_OVERWRITE): int` at `App/Utilities/Traits/ArrayTrait.php:369`
  - `public function diffUKey(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:382`
  - `public function intersectUKey(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:395`
  - `public function uDiffUAssoc(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:406`
  - `public function uIntersectUAssoc(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:417`
  - `public function keyExists(array $array, int|string $key): bool` at `App/Utilities/Traits/ArrayTrait.php:429`
  - `public function getKeys(array $data): array` at `App/Utilities/Traits/ArrayTrait.php:440`
  - `public function getValues(array $data): array` at `App/Utilities/Traits/ArrayTrait.php:451`
  - `public function search(array $data, mixed $value): mixed` at `App/Utilities/Traits/ArrayTrait.php:463`
  - `public function flatten(array $data): array` at `App/Utilities/Traits/ArrayTrait.php:474`
  - `public function countValues(array $array): array` at `App/Utilities/Traits/ArrayTrait.php:485`
  - `public function uDiff(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:498`
  - `public function uDiffAssoc(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:511`
  - `public function uIntersectAssoc(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:524`
  - `public function merge(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:535`
  - `public function mergeRecursive(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:546`
  - `public function multisort(array &$array, int $sortFlags = SORT_REGULAR): bool` at `App/Utilities/Traits/ArrayTrait.php:558`
  - `public function pad(array $array, int $size, mixed $value): array` at `App/Utilities/Traits/ArrayTrait.php:575`
  - `public function replace(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:585`
  - `public function replaceRecursive(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:596`
  - `public function walk(array &$array, callable $callback, mixed $userdata = null): bool` at `App/Utilities/Traits/ArrayTrait.php:609`
  - `public function diffUAssoc(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:622`
  - `public function intersectUAssoc(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:635`
  - `public function uIntersect(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:648`
  - `public function natcasesort(array &$array): bool` at `App/Utilities/Traits/ArrayTrait.php:659`
  - `public function natsort(array &$array): bool` at `App/Utilities/Traits/ArrayTrait.php:670`
  - `public function sizeOf(array $array, int $mode = COUNT_NORMAL): int` at `App/Utilities/Traits/ArrayTrait.php:682`
  - `public function rand(array $array, int $num = 1): mixed` at `App/Utilities/Traits/ArrayTrait.php:694`
  - `public function reverse(array $array, bool $preserveKeys = false): array` at `App/Utilities/Traits/ArrayTrait.php:706`
  - `public function pop(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:717`
  - `public function push(array &$array, mixed ...$values): int` at `App/Utilities/Traits/ArrayTrait.php:729`
  - `public function shift(array &$array): mixed` at `App/Utilities/Traits/ArrayTrait.php:740`
  - `public function unshift(array &$array, mixed ...$values): int` at `App/Utilities/Traits/ArrayTrait.php:752`
  - `public function slice(array $array, int $offset, ?int $length = null, bool $preserveKeys = false): array` at `App/Utilities/Traits/ArrayTrait.php:766`
  - `public function splice(array &$array, int $offset, ?int $length = null, mixed $replacement = []): array` at `App/Utilities/Traits/ArrayTrait.php:780`
  - `public function product(array $array): int|float` at `App/Utilities/Traits/ArrayTrait.php:791`
  - `public function sum(array $array): int|float` at `App/Utilities/Traits/ArrayTrait.php:802`
  - `public function unique(array $array, int $flags = SORT_STRING): array` at `App/Utilities/Traits/ArrayTrait.php:814`
  - `public function walkRecursive(array &$array, callable $callback): bool` at `App/Utilities/Traits/ArrayTrait.php:826`
  - `public function isList(array $array): bool` at `App/Utilities/Traits/ArrayTrait.php:837`
  - `public function arraykeyExists(int|string $key, array $array): bool` at `App/Utilities/Traits/ArrayTrait.php:849`
  - `public function differenceByKeys(array $array1, array $array2, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:862`
  - `public function replaceElements(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:873`
  - `public function filterNonEmpty(array $array): array` at `App/Utilities/Traits/ArrayTrait.php:884`
  - `public function diffKeyRecursive(array $array1, array $array2): array` at `App/Utilities/Traits/ArrayTrait.php:896`
  - `public function reduce(array $array, callable $callback, mixed $initial = null): mixed` at `App/Utilities/Traits/ArrayTrait.php:915`
  - `public function shuffle(array $array): array` at `App/Utilities/Traits/ArrayTrait.php:926`
  - `public function sortRecursive(array &$array): void` at `App/Utilities/Traits/ArrayTrait.php:939`
  - `public function mergeUnique(array ...$arrays): array` at `App/Utilities/Traits/ArrayTrait.php:955`
  - `public function partition(array $array, callable $callback): array` at `App/Utilities/Traits/ArrayTrait.php:967`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Database/Query.php`, `App/Utilities/Managers/System/SettingsManager.php`
- Methods: `11` total (`11` public, `0` protected, `0` private)
  ...
  - `public function isNumeric(string $input): bool` at `App/Utilities/Traits/CheckerTrait.php:42`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Http/Response.php`, `App/Abstracts/Presentation/Presenter.php`
- Methods: `15` total (`15` public, `0` protected, `0` private)
  ...
  - `public function toJson(mixed $input, int $flags = 0): string` at `App/Utilities/Traits/ConversionTrait.php:79`
  - `public function fromJson(string $json, bool $assoc = true, int $depth = 512, int $flags = 0): mixed` at `App/Utilities/Traits/ConversionTrait.php:93`
  - `public function toDateTime(string $input, string $format = 'Y-m-d H:i:s'): \DateTime|false` at `App/Utilities/Traits/ConversionTrait.php:107`
  - `public function fromDateTime(\DateTime $date, string $format = 'Y-m-d H:i:s'): string` at `App/Utilities/Traits/ConversionTrait.php:119`
  - `public function serializeData(mixed $input): string` at `App/Utilities/Traits/ConversionTrait.php:132`
  - `public function unserializeData(string $input): mixed` at `App/Utilities/Traits/ConversionTrait.php:143`
  - `public function binToHex(string $input): string` at `App/Utilities/Traits/ConversionTrait.php:156`
  - `public function hexToBin(string $input): string` at `App/Utilities/Traits/ConversionTrait.php:167`
  - `public function stringToArray(string $input): array` at `App/Utilities/Traits/ConversionTrait.php:178`
  - `public function arrayToString(array $input): string` at `App/Utilities/Traits/ConversionTrait.php:189`
...
- Properties:
  - `public readonly array $traitConstants` at `App/Utilities/Traits/DateTimeTrait.php:14`
- Methods: `20` total (`20` public, `0` protected, `0` private)
  - `public function __construct()` at `App/Utilities/Traits/DateTimeTrait.php:16`
  - `public function isValidDate(int $month, int $day, int $year): bool` at `App/Utilities/Traits/DateTimeTrait.php:51`
  - `public function formatTimestamp(string $format, ?int $timestamp = null): string` at `App/Utilities/Traits/DateTimeTrait.php:63`
  - `public function getDefaultTimezone(): string` at `App/Utilities/Traits/DateTimeTrait.php:73`
  - `public function setDefaultTimezone(string $timezone): bool` at `App/Utilities/Traits/DateTimeTrait.php:84`
  - `public function parseDate(string $datetime): array` at `App/Utilities/Traits/DateTimeTrait.php:95`
  - `public function parseDateFromFormat(string $format, string $datetime): array` at `App/Utilities/Traits/DateTimeTrait.php:107`
  - `public function getSunInfo(float $latitude, float $longitude, int $timestamp): array` at `App/Utilities/Traits/DateTimeTrait.php:120`
  - `public function getSunrise(float $latitude, float $longitude, int $timestamp, int $returnFormat = SUNFUNCS_RET_STRING): string|int|float` at `App/Utilities/Traits/DateTimeTrait.php:134`
  - `public function getSunset(float $latitude, float $longitude, int $timestamp, int $returnFormat = SUNFUNCS_RET_STRING): string|int|float` at `App/Utilities/Traits/DateTimeTrait.php:148`
  - `public function getDateInfo(?int $timestamp = null): array` at `App/Utilities/Traits/DateTimeTrait.php:159`
  - `public function getMicroTime(bool $asFloat = false): string|float` at `App/Utilities/Traits/DateTimeTrait.php:170`
  - `public function getCurrentTimestamp(): int` at `App/Utilities/Traits/DateTimeTrait.php:180`
  - `public function parseToTimestamp(string $datetime, ?int $baseTimestamp = null): int|false` at `App/Utilities/Traits/DateTimeTrait.php:192`
  - `public function formatGmtDate(string $format, ?int $timestamp = null): string` at `App/Utilities/Traits/DateTimeTrait.php:204`
  - `public function getLocalTime(bool $asAssociativeArray = true): array|int` at `App/Utilities/Traits/DateTimeTrait.php:215`
  - `public function listTimeZoneAbbreviations(): array` at `App/Utilities/Traits/DateTimeTrait.php:225`
  - `public function listTimeZoneIdentifiers(int $group = DateTimeZone::ALL, ?string $country = null): array` at `App/Utilities/Traits/DateTimeTrait.php:237`
  - `public function getTimeZoneNameFromAbbr(string $abbr, int $offset = 0, int $isDST = 0): string|false` at `App/Utilities/Traits/DateTimeTrait.php:250`
  - `public function getTimeZoneDbVersion(): string` at `App/Utilities/Traits/DateTimeTrait.php:260`
...
- Current consumers: `App/Abstracts/Database/Query.php`, `App/Abstracts/Http/Response.php`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Data/Finder.php`, `App/Abstracts/Database/Query.php`, `App/Abstracts/Http/Controller.php`, `App/Abstracts/Http/Middleware.php`, `App/Abstracts/Http/Request.php`, `App/Abstracts/Http/Response.php`, `App/Abstracts/Http/Service.php`, `App/Abstracts/Presentation/Presenter.php`, `App/Abstracts/Presentation/View.php`, `App/Core/App.php`, `App/Core/Config.php`, `App/Core/Database.php`, `App/Core/Router.php`, `App/Core/Session.php`, `App/Utilities/Handlers/NamespaceResolveHandler.php`, `App/Utilities/Handlers/NumberFormatterHandler.php`, `App/Utilities/Managers/Data/CacheManager.php`, `App/Utilities/Managers/Data/ModuleManager.php`, `App/Utilities/Managers/System/SettingsManager.php`
- Methods: `1` total (`1` public, `0` protected, `0` private)
  - `public function wrapInTry(callable $callback, string|Throwable|callable|null $wrapException = null): mixed` at `App/Utilities/Traits/ErrorTrait.php:20`
...
- Current consumers: `App/Abstracts/Data/Sanitizer.php`, `App/Abstracts/Data/Validator.php`, `App/Utilities/Handlers/NamespaceResolveHandler.php`, `App/Utilities/Managers/System/ErrorManager.php`
...
- Current consumers: none found outside the traits layer
- Methods: `11` total (`11` public, `0` protected, `0` private)
  - `public function hash(string $data, string $algorithm = 'sha256'): string` at `App/Utilities/Traits/HashingTrait.php:20`
  ...
  - `public function passwordHash(string $password, int $algo = PASSWORD_ARGON2ID): string` at `App/Utilities/Traits/HashingTrait.php:62`
  - `public function verifyPassword(string $password, string $hash): bool` at `App/Utilities/Traits/HashingTrait.php:74`
  - `public function compare(string $known, string $userInput): bool` at `App/Utilities/Traits/HashingTrait.php:86`
  - `public function getAvailableAlgorithms(): array` at `App/Utilities/Traits/HashingTrait.php:96`
  - `public function hashFile(string $filename, string $algorithm = 'sha256', bool $rawOutput = false): string|false` at `App/Utilities/Traits/HashingTrait.php:109`
  - `public function hmacFile(string $filename, string $key, string $algorithm = 'sha256', bool $rawOutput = false): string|false` at `App/Utilities/Traits/HashingTrait.php:123`
  - `public function getHashState(string $algorithm): array` at `App/Utilities/Traits/HashingTrait.php:134`
  - `public function computeRollingHash(string $data, int $type, int $state = 0): int` at `App/Utilities/Traits/HashingTrait.php:147`
...
- Methods: `5` total (`5` public, `0` protected, `0` private)
  - `public function setLocale(string $locale): string` at `App/Utilities/Traits/LocaleUtilityTrait.php:18`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Data/Finder.php`
- Methods: `7` total (`7` public, `0` protected, `0` private)
  - `public function each(array $array, callable $callback): string` at `App/Utilities/Traits/LoopTrait.php:19`
  - `public function count(int $start, int $end, callable $callback): void` at `App/Utilities/Traits/LoopTrait.php:35`
  ...
  - `public function repeat(int $times, callable $callback): void` at `App/Utilities/Traits/LoopTrait.php:81`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Database/Query.php`, `App/Abstracts/Http/Response.php`, `App/Abstracts/Presentation/Presenter.php`
- Methods: `23` total (`23` public, `0` protected, `0` private)
  - `public function split(string $delimiter, string $string): array` at `App/Utilities/Traits/ManipulationTrait.php:21`
  - `public function join(string $glue, array $pieces): string` at `App/Utilities/Traits/ManipulationTrait.php:33`
  - `public function pad(string $input, int $length, string $padStr = ' ', int $padType = STR_PAD_RIGHT): string` at `App/Utilities/Traits/ManipulationTrait.php:49`
  - `public function replace(string|array $search, string|array $replace, string|array $subject, ?int &$count = null): string|array` at `App/Utilities/Traits/ManipulationTrait.php:65`
  - `public function findIgnoreCase(string $haystack, string $needle): string|false` at `App/Utilities/Traits/ManipulationTrait.php:77`
  - `public function findFirst(string $haystack, string $needle): int|false` at `App/Utilities/Traits/ManipulationTrait.php:89`
  - `public function findLast(string $haystack, string $needle): int|false` at `App/Utilities/Traits/ManipulationTrait.php:101`
  - `public function findSubstring(string $haystack, string $needle): string|false` at `App/Utilities/Traits/ManipulationTrait.php:113`
  - `public function compareIgnoreCase(string $str1, string $str2): int` at `App/Utilities/Traits/ManipulationTrait.php:127`
  - `public function length(string $string): int` at `App/Utilities/Traits/ManipulationTrait.php:140`
  - `public function substring(string $string, int $start, ?int $length = null): string` at `App/Utilities/Traits/ManipulationTrait.php:153`
  - `public function splitToArray(string $string, int $length = 1): array` at `App/Utilities/Traits/ManipulationTrait.php:165`
  - `public function toLower(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:178`
  - `public function toUpper(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:189`
  - `public function capitalizeWords(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:200`
  - `public function trim(string $string, string $characters = " \t\n\r\0\x0B"): string` at `App/Utilities/Traits/ManipulationTrait.php:214`
  - `public function trimLeft(string $string, string $characters = " \t\n\r\0\x0B"): string` at `App/Utilities/Traits/ManipulationTrait.php:226`
  - `public function trimRight(string $string, string $characters = " \t\n\r\0\x0B"): string` at `App/Utilities/Traits/ManipulationTrait.php:238`
  - `public function reverse(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:251`
  - `public function repeat(string $input, int $multiplier): string` at `App/Utilities/Traits/ManipulationTrait.php:263`
  - `public function shuffle(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:276`
  - `public function escapeHtml(string $string): string` at `App/Utilities/Traits/ManipulationTrait.php:289`
  - `public function tokenizeString(string $input, string $delimiters): array` at `App/Utilities/Traits/ManipulationTrait.php:294`
...
- Current consumers: `App/Abstracts/Data/Cache.php`, `App/Abstracts/Presentation/Presenter.php`
- Methods: `6` total (`5` public, `0` protected, `1` private)
  ...
  - `public function soundsLike(string $str1, string $str2): bool` at `App/Utilities/Traits/MetricsTrait.php:44`
...
- Methods: `11` total (`11` public, `0` protected, `0` private)
  ...
  - `public function getClassMethods(object|string $class): array` at `App/Utilities/Traits/RetrieverTrait.php:31`
...
- Current consumers: `App/Abstracts/Data/Sanitizer.php`, `App/Abstracts/Data/Validator.php`, `App/Abstracts/Database/Query.php`, `App/Core/Database.php`, `App/Utilities/Handlers/NamespaceResolveHandler.php`, `App/Utilities/Managers/Data/CacheManager.php`, `App/Utilities/Managers/Data/ModuleManager.php`, `App/Utilities/Managers/System/ErrorManager.php`, `App/Utilities/Managers/System/SettingsManager.php`
...
- Current consumers: none found outside the traits layer
- Methods: `16` total (`0` public, `16` protected, `0` private)
  - `protected function filterByPath($fileInfo, string $path): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:33`
  - `protected function filterByName($fileInfo, string $name, bool $caseSensitive = true): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:46`
  - `protected function filterByType($fileInfo, string $type = 'directory'): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:59`
  - `protected function filterByOwner($fileInfo, int $owner): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:71`
  - `protected function filterByGroup($fileInfo, int $group): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:83`
  - `protected function filterByPermissions($fileInfo, int $permissions): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:95`
  - `protected function filterByModifiedTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:107`
  - `protected function filterByAccessedTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:119`
  - `protected function filterByCreationTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:131`
  - `protected function filterByDepth($fileInfo, int $maxDepth): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:143`
  - `protected function filterBySymlink($fileInfo): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:154`
  - `protected function filterByExecutable($fileInfo): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:165`
  - `protected function filterByWritable($fileInfo): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:176`
  - `protected function filterByReadable($fileInfo): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:187`
  - `protected function filterByPatternName($fileInfo, string $pattern): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:199`
  - `protected function filterByPatternPath($fileInfo, string $pattern): bool` at `App/Utilities/Traits/Criteria/DirectoryCriteriaTrait.php:211`
...
- Current consumers: none found outside the traits layer
- Methods: `19` total (`0` public, `19` protected, `0` private)
  - `protected function filterByPath($fileInfo, string $path): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:36`
  - `protected function filterByName($fileInfo, string $name, bool $caseSensitive = true): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:49`
  - `protected function filterByExtension($fileInfo, string $extension): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:62`
  - `protected function filterByType($fileInfo, string $type = 'file'): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:74`
  - `protected function filterBySize($fileInfo, int $size): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:86`
  - `protected function filterByPermissions($fileInfo, int $permissions): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:98`
  - `protected function filterByOwner($fileInfo, int $owner): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:110`
  - `protected function filterByGroup($fileInfo, int $group): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:122`
  - `protected function filterByModifiedTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:134`
  - `protected function filterByAccessedTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:146`
  - `protected function filterByCreationTime($fileInfo, int $timestamp): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:158`
  - `protected function filterBySymlink($fileInfo): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:169`
  - `protected function filterByDepth($fileInfo, int $maxDepth): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:181`
  - `protected function filterByExecutable($fileInfo): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:192`
  - `protected function filterByWritable($fileInfo): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:203`
  - `protected function filterByReadable($fileInfo): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:214`
  - `protected function filterByPatternName($fileInfo, string $pattern): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:226`
  - `protected function filterByPatternExtension($fileInfo, string $pattern): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:238`
  - `protected function filterByPatternPath($fileInfo, string $pattern): bool` at `App/Utilities/Traits/Criteria/FileCriteriaTrait.php:250`
...
- Methods: `10` total (`9` public, `0` protected, `1` private)
  - `public function __construct()` at `App/Utilities/Traits/Filters/SanitationFilterTrait.php:24`
  ...
  - `public function sanitizeUrl(string $input): string` at `App/Utilities/Traits/Filters/SanitationFilterTrait.php:90`
  ...
  - `public function sanitizeFloat(string $input, array $flags = []): string` at `App/Utilities/Traits/Filters/SanitationFilterTrait.php:114`
...
- Methods: `11` total (`10` public, `0` protected, `1` private)
  - `public function __construct()` at `App/Utilities/Traits/Filters/ValidationFilterTrait.php:35`
  ...
  - `public function validateFloat(string $input, array $flags = []): bool` at `App/Utilities/Traits/Filters/ValidationFilterTrait.php:91`
  - `public function validateInt(string $input, array $flags = []): bool` at `App/Utilities/Traits/Filters/ValidationFilterTrait.php:103`
  ...
  - `public function validateUrl(string $input, array $flags = []): bool` at `App/Utilities/Traits/Filters/ValidationFilterTrait.php:150`
...
- Methods: `18` total (`18` public, `0` protected, `0` private)
  - `public function __construct()` at `App/Utilities/Traits/Iterator/IteratorTrait.php:36`
...
- Methods: `9` total (`9` public, `0` protected, `0` private)
  - `public function __construct()` at `App/Utilities/Traits/Iterator/RecursiveIteratorTrait.php:27`
...
- Methods: `6` total (`6` public, `0` protected, `0` private)
  ...
  - `public function replace(string|array $pattern, string|array $replacement, string|array $subject, int $limit = -1, ?int &$count = null): string|array|null` at `App/Utilities/Traits/Patterns/PatternTrait.php:52`
  ...
  - `public function split(string $pattern, string $subject, int $limit = -1, int $flags = 0): array|false` at `App/Utilities/Traits/Patterns/PatternTrait.php:81`
...
- Methods: `27` total (`27` public, `0` protected, `0` private)
  - `public function __construct()` at `App/Utilities/Traits/Patterns/SanitationPatternTrait.php:29`
  ...
  - `public function sanitizeUrl(string $input): ?string` at `App/Utilities/Traits/Patterns/SanitationPatternTrait.php:267`
  ...
  - `public function sanitizeFloat(string $input): ?string` at `App/Utilities/Traits/Patterns/SanitationPatternTrait.php:311`
...
- Properties:
  - `public readonly array $patterns` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:22`
- Methods: `44` total (`44` public, `0` protected, `0` private)
  - `public function __construct()` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:30`
  - `public function validateName(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:98`
  - `public function validateSsn(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:109`
  - `public function validatePhoneUs(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:120`
  - `public function validatePhoneIntl(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:131`
  - `public function validateHexadecimal(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:142`
  - `public function validateHexOnly(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:153`
  - `public function validateBinary(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:164`
  - `public function validateOctal(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:175`
  - `public function validateCreditCard(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:186`
  - `public function validateIsbn10(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:197`
  - `public function validateIban(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:208`
  - `public function validateBic(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:219`
  - `public function validateEthereumAddress(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:230`
  - `public function validateBitcoinAddress(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:241`
  - `public function validateFileName(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:252`
  - `public function validateDirectory(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:263`
  - `public function validatePathUnix(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:274`
  - `public function validatePathWindows(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:285`
  - `public function validateFileExt(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:296`
  - `public function validateImageExt(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:307`
  - `public function validateAudioExt(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:318`
  - `public function validateVideoExt(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:329`
  - `public function validateSlug(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:340`
  - `public function validateUrl(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:351`
  - `public function validateUrlPort(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:362`
  - `public function validateIpv4(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:373`
  - `public function validateIpv6(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:384`
  - `public function validateZipUs(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:395`
  - `public function validateZipUk(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:406`
  - `public function validateIntPos(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:417`
  - `public function validateIntNeg(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:428`
  - `public function validateInt(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:439`
  - `public function validateFloatPos(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:450`
  - `public function validateFloatNeg(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:461`
  - `public function validateFloat(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:472`
  - `public function validateScientific(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:483`
  - `public function validateAlpha(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:494`
  - `public function validateAlphaSpace(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:505`
  - `public function validateAlphaDash(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:516`
  - `public function validateAlphaNum(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:527`
  - `public function validateAlphaNumSpace(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:538`
  - `public function validateHashtag(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:549`
  - `public function validateTwitterHandle(string $input): bool` at `App/Utilities/Traits/Patterns/ValidationPatternTrait.php:560`
...
- Type: `method provider`
- Summary: `DataQueryTrait`
- Current consumers: `App/Utilities/Query/DataQuery.php`
- Methods: `74` total (`74` public, `0` protected, `0` private)
  - `public function where(string $column, string $operator, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:31`
  - `public function having(string $column, string $operator, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:46`
  - `public function on(string $column, string $operator, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:61`
  - `public function filter(string $column, string $operator, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:77`
  - `public function fetch(int $rowCount): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:88`
  - `public function returning(array $columns): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:101`
  - `public function with(string $queryAlias, callable $subquery): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:115`
  - `public function not(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:130`
  - `public function and(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:141`
  - `public function or(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:152`
  - `public function xor(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:163`
  - `public function andNot(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:174`
  - `public function orNot(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:185`
  - `public function all(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:196`
  - `public function any(array $conditions): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:207`
  - `public function equal(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:223`
  - `public function notEqual(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:235`
  - `public function notEqualAlt(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:247`
  - `public function nullSafeEqual(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:261`
  - `public function greaterThan(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:273`
  - `public function greaterThanOrEqual(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:285`
  - `public function lessThan(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:297`
  - `public function lessThanOrEqual(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:309`
  - `public function isDistinctFrom(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:323`
  - `public function notDistinctFrom(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:337`
  - `public function isNull(string $column): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:352`
  - `public function isNotNull(string $column): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:363`
  - `public function in(string $column, array $values): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:381`
  - `public function notIn(string $column, array $values): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:395`
  - `public function exists(callable $subquery): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:408`
  - `public function notExists(callable $subquery): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:421`
  - `public function except(callable $query): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:434`
  - `public function intersect(callable $query): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:447`
  - `public function minus(callable $query): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:460`
  - `public function union(callable $query): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:473`
  - `public function unionAll(callable $query): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:486`
  - `public function between(string $column, mixed $start, mixed $end): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:505`
  - `public function notBetween(string $column, mixed $start, mixed $end): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:520`
  - `public function like(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:538`
  - `public function notLike(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:552`
  - `public function iLike(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:566`
  - `public function regexp(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:580`
  - `public function notRegexp(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:594`
  - `public function soundsLike(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:609`
  - `public function similarTo(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:623`
  - `public function notSimilarTo(string $column, string $pattern): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:637`
  - `public function connectBy(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:655`
  - `public function startWith(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:669`
  - `public function connectByPrior(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:683`
  - `public function prior(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:697`
  - `public function withRecursive(string $column, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:711`
  - `public function distinctOn(array $columns): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:724`
  - `public function overlaps(string $column, string $operator, mixed $value): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:743`
  - `public function forUpdate(): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:759`
  - `public function forShare(): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:771`
  - `public function join(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:788`
  - `public function fullOuterJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:803`
  - `public function leftJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:818`
  - `public function rightJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:833`
  - `public function innerJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:848`
  - `public function crossJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:863`
  - `public function naturalJoin(string $table, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:877`
  - `public function fullJoin(string $table, array $onConditions, array $columns = []): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:892`
  - `public function orderBy(string $column, string $direction = 'ASC'): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:910`
  - `public function groupBy(array $columns): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:923`
  - `public function groupingSets(array $sets): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:936`
  - `public function cube(array $columns): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:949`
  - `public function rollup(array $columns): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:962`
  - `public function limit(int $limit): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:979`
  - `public function offset(int $offset): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:992`
  - `public function insert(string $table, array $data): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:1010`
  - `public function select(array $columns = ['*']): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:1023`
  - `public function update(string $table, array $data): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:1037`
  - `public function delete(string $table): self` at `App/Utilities/Traits/Query/DataQueryTrait.php:1050`
...
- Methods: `41` total (`40` public, `0` protected, `1` private)
  - `private function chainSchema(callable $callback): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:7`
  - `public function addColumn(string $table, string $column, string $definition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:14`
  - `public function removeColumn(string $table, string $column): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:19`
  - `public function renameColumn(string $table, string $oldName, string $newName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:24`
  - `public function modifyColumn(string $table, string $column, string $newDefinition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:29`
  - `public function createTable(string $table, array $columns, array $constraints = []): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:34`
  - `public function renameTable(string $oldName, string $newName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:39`
  - `public function truncateTable(string $table): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:44`
  - `public function dropTable(string $table): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:49`
  - `public function alterTable(string $table, array $options): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:54`
  - `public function addIndex(string $table, string $indexName, array $columns, string $indexType = ''): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:59`
  - `public function dropIndex(string $table, string $indexName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:66`
  - `public function renameIndex(string $table, string $oldIndexName, string $newIndexName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:71`
  - `public function setConstraint(string $table, string $constraint, array $definition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:78`
  - `public function dropConstraint(string $table, string $constraint): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:85`
  - `public function renameConstraint(string $table, string $oldConstraint, string $newConstraint): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:90`
  - `public function setUnique(string $table, array $columns): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:97`
  - `public function dropUnique(string $table, string $constraint): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:102`
  - `public function setCheck(string $table, string $constraint, string $condition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:107`
  - `public function dropCheck(string $table, string $constraint): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:114`
  - `public function setForeign(string $table, string $column, string $referencedTable, string $referencedColumn, string $onDelete = 'RESTRICT', string $onUpdate = 'RESTRICT'): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:119`
  - `public function dropForeign(string $table, string $foreignKeyName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:141`
  - `public function addPrimary(string $table, array $columns): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:146`
  - `public function dropPrimary(string $table): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:151`
  - `public function setDefault(string $table, string $column, mixed $defaultValue): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:156`
  - `public function dropDefault(string $table, string $column): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:161`
  - `public function createView(string $viewName, string $selectQuery): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:166`
  - `public function dropView(string $viewName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:171`
  - `public function alterView(string $viewName, string $selectQuery): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:176`
  - `public function createTrigger(string $triggerName, string $table, string $timing, string $event, string $statement): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:181`
  - `public function dropTrigger(string $triggerName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:193`
  - `public function alterTrigger(string $triggerName, string $table, string $timing, string $event, string $statement): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:198`
  - `public function createDatabase(string $database): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:210`
  - `public function dropDatabase(string $database): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:215`
  - `public function alterDatabase(string $database, array $options): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:220`
  - `public function createProcedure(string $procedureName, string $definition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:225`
  - `public function dropProcedure(string $procedureName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:230`
  - `public function createFunction(string $functionName, string $definition): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:235`
  - `public function dropFunction(string $functionName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:240`
  - `public function createSequence(string $sequenceName, array $options = []): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:245`
  - `public function dropSequence(string $sequenceName): self` at `App/Utilities/Traits/Query/SchemaQueryTrait.php:250`
...
- Methods: `63` total (`63` public, `0` protected, `0` private)
  ...
  - `public function getClassMethods(ReflectionClass $reflectionClass, ?int $filter = null): array` at `App/Utilities/Traits/Reflection/ReflectionClassTrait.php:198`
...
- Methods: `27` total (`27` public, `0` protected, `0` private)
  - `public function ruleRequire(mixed $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:20`
  - `public function ruleMin(float|int $input, float|int $min): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:32`
  - `public function ruleMax(float|int $input, float|int $max): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:44`
  - `public function ruleBetween(float|int $input, float|int $min, float|int $max): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:57`
  - `public function ruleLess(float|int $input, float|int $threshold): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:69`
  - `public function ruleGreater(float|int $input, float|int $threshold): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:81`
  - `public function ruleMinLength(string $input, int $min): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:93`
  - `public function ruleMaxLength(string $input, int $max): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:105`
  - `public function ruleLengthBetween(string $input, int $min, int $max): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:118`
  - `public function ruleInArray(mixed $input, array $array): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:130`
  - `public function ruleNotInArray(mixed $input, array $array): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:142`
  - `public function ruleIsInt(mixed $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:153`
  - `public function ruleIsFloat(mixed $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:164`
  - `public function ruleIsString(mixed $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:175`
  - `public function ruleIsBoolean(mixed $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:186`
  - `public function ruleIsAssociativeArray(array $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:197`
  - `public function ruleArrayUnique(array $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:208`
  - `public function ruleDivisibleBy(int $input, int $divisor): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:220`
  - `public function ruleNotEmpty(string $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:231`
  - `public function ruleStep(float|int $input, float|int $step, float|int $base = 0): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:244`
  - `public function ruleArraySize(array $input, int $min, int $max): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:257`
  - `public function ruleSequential(array $numbers, bool $allowGaps = false): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:269`
  - `public function ruleStartsWith(string $input, string $prefix): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:284`
  - `public function ruleEndsWith(string $input, string $suffix): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:296`
  - `public function rulePositive(float|int $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:307`
  - `public function ruleNegative(float|int $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:318`
  - `public function ruleArrayNotEmpty(array $input): bool` at `App/Utilities/Traits/Rules/RuleTrait.php:329`
...
- Current consumers: none found outside the traits layer
- Methods: `8` total (`0` public, `8` protected, `0` private)
  - `protected function sortByName($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:20`
  - `protected function sortByPath($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:32`
  - `protected function sortByModifiedTime($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:44`
  - `protected function sortByAccessedTime($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:56`
  - `protected function sortByCreationTime($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:68`
  - `protected function sortByPermissions($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:80`
  - `protected function sortByOwner($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:92`
  - `protected function sortByGroup($a, $b): int` at `App/Utilities/Traits/Sort/DirectorySortTrait.php:104`
...
- Current consumers: none found outside the traits layer
- Methods: `10` total (`0` public, `10` protected, `0` private)
  - `protected function sortByName($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:29`
  - `protected function sortByPath($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:41`
  - `protected function sortBySize($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:53`
  - `protected function sortByExtension($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:65`
  - `protected function sortByModifiedTime($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:77`
  - `protected function sortByAccessedTime($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:89`
  - `protected function sortByCreationTime($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:101`
  - `protected function sortByPermissions($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:113`
  - `protected function sortByOwner($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:125`
  - `protected function sortByGroup($a, $b): int` at `App/Utilities/Traits/Sort/FileSortTrait.php:137`
